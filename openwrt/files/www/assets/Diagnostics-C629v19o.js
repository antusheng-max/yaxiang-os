import{_ as V}from"./index-DZbJQmlA.js";import{O as C,W as a,aj as n,L as d,a0 as t,_ as N,M as P,P as v,$ as x,Z as q,k as m}from"./vue-HEoUudR2.js";import"./element-plus-BHP9dPzY.js";const h={key:0,class:"diag-output"},w={__name:"Diagnostics",setup(B){const e=m("8.8.8.8"),s=m("ping"),r=m(!1),l=m("");function _(){r.value=!0,l.value="",setTimeout(()=>{s.value==="ping"?l.value=`PING ${e.value} (${e.value}): 56 data bytes
