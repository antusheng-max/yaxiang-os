import{_ as V}from"./index-1AaNop9G.js";import{aj as n,L as d,O as C,W as a,a0 as t,_ as N,M as P,P as v,$ as x,Z as q,k as m}from"./vue-DlDuuzau.js";import"./element-plus-Hw3m4APv.js";const h={key:0,class:"diag-output"},w={__name:"Diagnostics",setup(B){const e=m("8.8.8.8"),s=m("ping"),r=m(!1),l=m("");function _(){r.value=!0,l.value="",setTimeout(()=>{s.value==="ping"?l.value=`PING ${e.value} (${e.value}): 56 data bytes
